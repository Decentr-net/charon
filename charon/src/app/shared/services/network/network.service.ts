...
import { Network as NetworkWithName, NetworkSelectorStoreService } from '@shared/components/network-selector';
import {
  Network as NetworkWithApi,
  NetworkBrowserStorageService,
} from '../../../../../../shared/services/network-storage';

export type Network = NetworkWithName & NetworkWithApi;

@UntilDestroy()
@Injectable()
export class NetworkService extends NetworkSelectorStoreService {
