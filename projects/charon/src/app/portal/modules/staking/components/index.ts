import { StakingExtendedErrorComponent } from './staking-extended-error';
import { StakingLayoutComponent } from './staking-layout';
...
import { WithdrawValidatorTableComponent } from './withdraw-validator-table';

export const STAKING_COMPONENTS = [
  StakingExtendedErrorComponent,
  StakingLayoutComponent,
