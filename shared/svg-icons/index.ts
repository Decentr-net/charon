...
export * from './svg/svg-github.icon';
...
export * from './svg/svg-logo-feed.icon';
...
export * from './svg/svg-logo-portal.icon';
export * from './svg/svg-logo.icon';
export * from './svg/svg-medium.icon';
...
export * from './svg/svg-telegram.icon';
